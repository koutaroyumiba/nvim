...
M.on_attach = function(event)
    ...
    keymap("n", "<leader>gr", "<cmd>FzfLua lsp_references<CR>", opts) -- show all references to symbol under cursor
    keymap("n", "<leader>gt", "<cmd>FzfLua lsp_typedefs<CR>", opts) -- jump to the typedefs of symbol under cursor
